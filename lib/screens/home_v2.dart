...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void getUserDetails() async {
    var res = await _apiService.getDataV2("/api/auth/user/");
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: currentUser.user.email == null
            ? const LoadingScreen()
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      CircleAvatar(
                          ...
                          backgroundImage:
                              NetworkImage(currentUser.user.profile.avatarUrl)
                          // child: Text(
                          //   'GN',
                          //   style: TextStyle(
                          //     fontFamily: 'Baloo2',
                                  ...
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(
                                          text:
                                              "Plan: ${currentUser.user.profile.pastPlanName}\n",
                                          style: TextStyle(
                                            fontFamily: 'Baloo2',
                                            fontSize: 12.sm,
                                        ...
                                        TextSpan(
                                          text:
                                              "₦${humanize.intComma(double.parse(currentUser.user.profile.pastPlanPrice).toInt())}",
                                          style: TextStyle(
                                            fontFamily: 'Baloo2',
                                            fontSize: 25.sm,
                                  ...
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(
                                          text:
                                              "₦${humanize.intComma(double.parse(currentUser.user.myBalance).toInt())}",
                                          style: TextStyle(
                                            fontFamily: 'Baloo2',
                                            fontSize: 15.sm,
                                            fontWeight: FontWeight.w100,
                                  ...
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(
                                          text:
                                              "₦${humanize.intComma(double.parse(currentUser.user.profile.pendingBalance).toInt())}",
                                          style: TextStyle(
                                            fontFamily: 'Baloo2',
                                            fontSize: 10.sm,
                                            fontWeight: FontWeight.w100,
                              ...
                              RichText(
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(
                                      text:
                                          "Last purchased ${currentUser.user.profile.pastPlanName} plan\n",
                                      style: TextStyle(
                                        fontFamily: 'Baloo2',
                                        fontSize: 14.sm,
                                        fontWeight: FontWeight.w700,
